...
import uuid
import warnings
from llserver.prompts.prompts_gemini import PROMPTS as gemini_prompts
from llserver.prompts.prompts_openai import PROMPTS as openai_prompts
...
class LLERa_API:
    def __init__(self, logger=None):
        ...
        self.logger.log(f"Привет, я LLERa_API")
    ...
    async def _process_task(self, task_id, image_paths, prompt, **kwargs):
        ...
        prompt_templates = openai_prompts
        if "gemini" in model_name:
            prompt_templates = gemini_prompts
            self.logger.log("Using gemini prompts")
